...
class BrowserWindow(QMainWindow):
    def __init__(self):
        ...
        self.loc_chrome_input.setPlaceholderText("Enter location of Chrome app (e.g., C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe)")
        ...
        self.loc_chrome_user_data_input.setPlaceholderText("Enter location of Chrome user data (e.g., C:\\Users\\<Username>\\AppData\\Local\\Google\\Chrome\\User Data)")
    ...
    async def run_agent(self, loc_chrome, loc_chrome_user_dt, api_key, task):
        ...
        config = BrowserConfig(
            chrome_instance_path=loc_chrome,
    ...
    def run_ai_task(self):
        ...
        if not loc_chrome_data:
            QMessageBox.information(self, "Empty Field", "Please enter location of Chrome user data")
            return
        
        if not api_key:
            QMessageBox.information(self, "Empty Field", "Please enter API Key for Gemini Model 2.0 Flash")
            return
        ...
        loop.run_until_complete(self.run_agent(loc_chrome, loc_chrome_data, api_key, task))
